...
- API version: 3.0.1
- Build date: 2022-10-19T23:21:49.501653+02:00[Europe/Amsterdam]
...
```
cargo run --example client FilesGet
```
...
------------- | ------------- | -------------
[****](docs/default_api.md#) | **GET** /files | 


## Documentation For Models

 - [FilesGet200ResponseInner](docs/FilesGet200ResponseInner.md)
